...
def find_mismatched_data(url: str, file_name: str) -> dict:
    """
    Compare with JSON file and find mismatches.
...
if __name__ == "__main__":
    ...
    #output
    # {'Kamino': [{'surface_water': {'Actual': '100', 'Expected': '1000'}}],
    #  'Tatooine': [{'terrain': {'Actual': 'desert', 'Expected': 'ocean'}},
    #               {'population': {'Actual': '200000', 'Expected': '100000'}}]}
    #
    # Process
    # finished
    # with exit code 0
